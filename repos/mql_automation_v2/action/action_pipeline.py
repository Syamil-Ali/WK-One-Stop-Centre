...
def main_pipeline(df_work, df_opp, df_opp_owner,  df_provider_new_territories, df_provider_new_assignment, df_acc):
    ...
    df_work[['Territory', 'Region', 'Sales Rep', 'Account Owner']] = df_work.apply(lambda x: sr.main_sales_rep(x, df_acc, df_provider_new_territories, df_provider_new_assignment), axis=1, result_type="expand")
