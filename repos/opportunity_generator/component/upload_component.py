...
from repos.opportunity_generator.component.spinner_component import render_spinner, unrender_spinner
import repos.opportunity_generator.action.action_pipeline as ap

main_file = 'Opportunity Generator'
sheet_names = [main_file, 'Opportunity Object', 'User Object', 'Account Object']
...
async def handle_upload(e):
    ...
    try:
        ...
        # do the work here
        app.storage.tab['main_file'] = await run.io_bound(
            ap.start_opp_gen_pipeline,
            app.storage.tab['main_file'],
            app.storage.tab['excel_sheets_dict']['Opportunity Object'],
            app.storage.tab['excel_sheets_dict']['Account Object'],
            app.storage.tab['excel_sheets_dict']['User Object']

        )

        # export
        fm.export_file(file_type = 'opportunity_generator')
...
async def excel_download_handler(input_url):
    ...
    try:
        ...
        app.storage.tab['file_name'] = 'Opportunity Generator'
