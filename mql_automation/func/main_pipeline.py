import pandas as pd
import polars as pl
from mql_automation.func import sales_rep as sr
from mql_automation.func import opp_func as of
from mql_automation.func import comment_generated as cg
...
def main_pipeline(df_work, df_opp, df_opp_owner, df_national_acc, df_provider_territories, df_provider_postal):
