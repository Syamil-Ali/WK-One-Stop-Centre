...
def opp_generator(df, opp_file, user_file, opp_type):
    ...
    try:
        ...
        opp_filter = opp_file[(opp_file['Product_Mix__c'] == opp_type) | (opp_file['Product_Mix__c'] == 'Combo')].copy()
        ...
        opp_filter = opp_filter[
            ~((opp_filter['Product_Mix__c'] == "Combo") &
        ...
        opp_filter_new = opp_filter[['AccountId', 'Product', 'Type','Close Date', 'Annual_Contract_Value__c', 'Opportunity ID', 'Product_Mix__c', 'OwnerId', 'Opportunity_Number__c']]
        ...
        col_rename = {
            ...
            "Annual_Contract_Value__c": f'{opp_type} - ACV',
            "Product": f"{opp_type} - Product",
            "AccountId": "Id",
            "Product_Mix__c": f"{opp_type} - Product Mix",
            "OwnerId": f"{opp_type} - OwnerId",
            "Opportunity_Number__c": f"{opp_type} - Opp Num"
        }
